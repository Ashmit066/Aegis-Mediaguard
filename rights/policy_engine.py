...
from rights.license_matrix import check_license_dates, check_platform, check_region
...
def evaluate_rights(
    ...
    is_authorized = platform_ok and region_ok and license_valid
    ...
    return RightsDecision(
        ...
        reasons=[platform_reason, region_reason, license_reason],
    )
